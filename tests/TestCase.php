...
abstract class TestCase extends Notadd\Foundation\Testing\TestCase {
    ...
    public function createApplication() {
        $application = new \Notadd\Foundation\Application(realpath(__DIR__ . '/../'));$application->singleton(Illuminate\Contracts\Http\Kernel::class, Notadd\Foundation\Http\Kernel::class);
