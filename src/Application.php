...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    public function registerCoreContainerAliases()
    {
        $data = [
            ...
            'jwt.manager'               => [\Tymon\JWTAuth\Manager::class],
            'jwt.payload.factory'       => [\Tymon\JWTAuth\Factory::class],
            'jwt.provider.auth'         => [\Tymon\JWTAuth\Contracts\Providers\Auth::class],
            'jwt.provider.jwt'          => [\Tymon\JWTAuth\Contracts\Providers\JWT::class],
            'jwt.provider.storage'      => [\Tymon\JWTAuth\Contracts\Providers\Storage::class],
